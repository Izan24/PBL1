...
void initZutabe() {
	...
	*/
	...
	surface = IMG_Load("resources/zutabetxo.png");
...
void initSpriteTexturak() {
	...
	*/
	...
	surface = IMG_Load("resources/spriteSua.png");
	spr[0][0] = SDL_CreateTextureFromSurface(rend, surface);
	SDL_FreeSurface(surface);
	surface = IMG_Load("resources/spriteSua2.png");
	spr[0][1] = SDL_CreateTextureFromSurface(rend, surface);
	SDL_FreeSurface(surface);
	surface = IMG_Load("resources/spriteSua3.png");
	spr[0][2] = SDL_CreateTextureFromSurface(rend, surface);
	SDL_FreeSurface(surface);
	surface = IMG_Load("resources/spriteSua4.png");
	spr[0][3] = SDL_CreateTextureFromSurface(rend, surface);
	SDL_FreeSurface(surface);

	surface = IMG_Load("resources/spriteSuaBluProba.png");
	spr[1][0] = SDL_CreateTextureFromSurface(rend, surface);
	SDL_FreeSurface(surface);
	surface = IMG_Load("resources/spriteSuaBluProba2.png");
	spr[1][1] = SDL_CreateTextureFromSurface(rend, surface);
	SDL_FreeSurface(surface);
	surface = IMG_Load("resources/spriteSuaBluProba3.png");
	spr[1][2] = SDL_CreateTextureFromSurface(rend, surface);
	SDL_FreeSurface(surface);
	surface = IMG_Load("resources/spriteSuaBluProba4.png");
	spr[1][3] = SDL_CreateTextureFromSurface(rend, surface);
	SDL_FreeSurface(surface);

	surface = IMG_Load("resources/spriteSuaBerdProb.png");
	spr[2][0] = SDL_CreateTextureFromSurface(rend, surface);
	SDL_FreeSurface(surface);
	surface = IMG_Load("resources/spriteSuaBerdProb2.png");
	spr[2][1] = SDL_CreateTextureFromSurface(rend, surface);
	SDL_FreeSurface(surface);
	surface = IMG_Load("resources/spriteSuaBerdProb3.png");
	spr[2][2] = SDL_CreateTextureFromSurface(rend, surface);
	SDL_FreeSurface(surface);
	surface = IMG_Load("resources/spriteSuaBerdProb4.png");
	spr[2][3] = SDL_CreateTextureFromSurface(rend, surface);
	SDL_FreeSurface(surface);

	surface = IMG_Load("resources/spriteSuaPurplProb.png");
	spr[3][0] = SDL_CreateTextureFromSurface(rend, surface);
	SDL_FreeSurface(surface);
	surface = IMG_Load("resources/spriteSuaPurplProb2.png");
	spr[3][1] = SDL_CreateTextureFromSurface(rend, surface);
	SDL_FreeSurface(surface);
	surface = IMG_Load("resources/spriteSuaPurplProb3.png");
	spr[3][2] = SDL_CreateTextureFromSurface(rend, surface);
	SDL_FreeSurface(surface);
	surface = IMG_Load("resources/spriteSuaPurplProb4.png");
...
void initNumeros()
{
	...
	*
	*/
	surface = IMG_Load("resources/0.png");
	numeros[0] = SDL_CreateTextureFromSurface(rend, surface);

	SDL_FreeSurface(surface);
	surface = IMG_Load("resources/1.png");
	numeros[1] = SDL_CreateTextureFromSurface(rend, surface);

	SDL_FreeSurface(surface);
	surface = IMG_Load("resources/2.png");
	numeros[2] = SDL_CreateTextureFromSurface(rend, surface);

	SDL_FreeSurface(surface);
	surface = IMG_Load("resources/3.png");
	numeros[3] = SDL_CreateTextureFromSurface(rend, surface);

	SDL_FreeSurface(surface);
	surface = IMG_Load("resources/4.png");
	numeros[4] = SDL_CreateTextureFromSurface(rend, surface);

	SDL_FreeSurface(surface);
	surface = IMG_Load("resources/5.png");
	numeros[5] = SDL_CreateTextureFromSurface(rend, surface);

	SDL_FreeSurface(surface);
	surface = IMG_Load("resources/6.png");
	numeros[6] = SDL_CreateTextureFromSurface(rend, surface);

	SDL_FreeSurface(surface);
	surface = IMG_Load("resources/7.png");
	numeros[7] = SDL_CreateTextureFromSurface(rend, surface);

	SDL_FreeSurface(surface);
	surface = IMG_Load("resources/8.png");
	numeros[8] = SDL_CreateTextureFromSurface(rend, surface);

	SDL_FreeSurface(surface);
	surface = IMG_Load("resources/9.png");
	numeros[9] = SDL_CreateTextureFromSurface(rend, surface);
...
void initPuntuPantaila()
{
	...
	*
	*/
	surface = IMG_Load("resources/2players.png");
	puntuPantaila[0] = SDL_CreateTextureFromSurface(rend, surface);

	SDL_FreeSurface(surface);
	surface = IMG_Load("resources/3players.png");
	puntuPantaila[1] = SDL_CreateTextureFromSurface(rend, surface);

	SDL_FreeSurface(surface);
	surface = IMG_Load("resources/4players.png");
...
void initBlink() {
	...
	*/
	...
	surface = IMG_Load("resources/flashAtze1.png");
	blink[0] = SDL_CreateTextureFromSurface(rend, surface);
	SDL_FreeSurface(surface);

	surface = IMG_Load("resources/flashAtze2.png");
	blink[1] = SDL_CreateTextureFromSurface(rend, surface);
	SDL_FreeSurface(surface);

	surface = IMG_Load("resources/flashAtze3.png");
...
void initKeia() {
	...
	*
	*/
	surface = IMG_Load("resources/keia1.png");
	keia[0] = SDL_CreateTextureFromSurface(rend, surface);
	SDL_FreeSurface(surface);

	surface = IMG_Load("resources/keia2.png");
	keia[1] = SDL_CreateTextureFromSurface(rend, surface);
	SDL_FreeSurface(surface);

	surface = IMG_Load("resources/keia3.png");
	keia[2] = SDL_CreateTextureFromSurface(rend, surface);
	SDL_FreeSurface(surface);

	surface = IMG_Load("resources/keia4.png");
...
void creditos() {
	...
	*/
	...
	SDL_Rect textLocation, spriteLocation[2];
	textLocation.x = 0;
	textLocation.y = 0;
	textLocation.w = 0;
	textLocation.h = 0;
	...
	while (!skipRequested && timer < 3000) {
		...
		if (timer == 1) {
			...
			SDL_RenderClear(rend);
			strcpy(creditText, "But something was diferent.");
			w = 800;
			h = letraHeight;
			DrawText(textSurface, font, foregroundColor, textLocation, x - (w / 2), y - (h / 2), w, h);
			strcpy(creditText, "Press ESC to skip intro...");
